...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.command.weeklyreport' => 'getApp_Command_WeeklyreportService',
            ...
            'service_apsource_presenter' => 'getServiceApsourcePresenterService',
            ...
            'service_weeklyreport' => 'getServiceWeeklyreportService',
        ...
        $this->aliases = array(
            ...
            'console.command.optimus_optimusbundle_command_weeklyreportcommand' => 'app.command.weeklyreport',
    ...
    /**
     * Gets the 'app.command.weeklyreport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Command\WeeklyReportCommand A Optimus\OptimusBundle\Command\WeeklyReportCommand instance.
     */
    protected function getApp_Command_WeeklyreportService()
    {
        return $this->services['app.command.weeklyreport'] = new \Optimus\OptimusBundle\Command\WeeklyReportCommand();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Optimus\\OptimusBundle\\Entity'))), 'Optimus\\OptimusBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('OptimusOptimusBundle' => 'Optimus\\OptimusBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_50c0a12340acf809d37b6d0f8f84466d5fa9fe197142e968edffc0ceaa09bef8');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Optimus\\OptimusBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $h, $i, array('check_path' => '/login_check', 'username_parameter' => '_lastname', 'use_forward' => false, 'require_previous_session' => true, 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $f, 'secured_area', $j, $b), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '573f16db60cc4', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', $j, NULL, NULL, $b));
    }
    ...
    /**
     * Gets the 'service_apadaptative' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceAPAdaptative A Optimus\OptimusBundle\Servicios\ServiceAPAdaptative instance.
     */
    protected function getServiceApadaptativeService()
    {
        return $this->services['service_apadaptative'] = new \Optimus\OptimusBundle\Servicios\ServiceAPAdaptative($this->get('doctrine.orm.default_entity_manager'), $this->get('service_ontologia'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceAPPreheating A Optimus\OptimusBundle\Servicios\ServiceAPPreheating instance.
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceAPEnergySourceCalculation A Optimus\OptimusBundle\Servicios\ServiceAPEnergySourceCalculation instance.
     */
    protected function getServiceApsourceService()
    {
        return $this->services['service_apsource'] = new \Optimus\OptimusBundle\Servicios\ServiceAPEnergySourceCalculation($this->get('doctrine.orm.default_entity_manager'), $this->get('service_ontologia'), $this->get('service_predict_data_invoke'), $this->get('service_event'));
    }

    /**
     * Gets the 'service_apsource_presenter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceAPEnergySourcePresenter A Optimus\OptimusBundle\Servicios\ServiceAPEnergySourcePresenter instance.
     */
    protected function getServiceApsourcePresenterService()
    {
        return $this->services['service_apsource_presenter'] = new \Optimus\OptimusBundle\Servicios\ServiceAPEnergySourcePresenter($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'service_aptsv' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceAPTSV A Optimus\OptimusBundle\Servicios\ServiceAPTSV instance.
     */
    protected function getServiceAptsvService()
    {
        return $this->services['service_aptsv'] = new \Optimus\OptimusBundle\Servicios\ServiceAPTSV($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'service_calculo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceCalculos A Optimus\OptimusBundle\Servicios\ServiceCalculos instance.
     */
    protected function getServiceCalculoService()
    {
        return $this->services['service_calculo'] = new \Optimus\OptimusBundle\Servicios\ServiceCalculos($this->get('service_ontologia'), $this->get('service_service_calculation_data_invoke'), $this->get('service_predict_data_invoke'), $this->get('doctrine.orm.default_entity_manager'), $this->get('service_appv'), $this->get('service_appvm'), $this->get('service_apeconomizer'), $this->get('service_appreheating'), $this->get('service_apspmc'), $this->get('service_apoc'), $this->get('service_event'), $this->get('service_pricepredictor'), 40, 80, 1, 1, $this->get('service_apsource'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceDataCapturing A Optimus\OptimusBundle\Servicios\ServiceDataCapturing instance.
     */
    ...
    /**
     * Gets the 'service_ontologia' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceOntologia A Optimus\OptimusBundle\Servicios\ServiceOntologia instance.
     */
    protected function getServiceOntologiaService()
    {
        return $this->services['service_ontologia'] = new \Optimus\OptimusBundle\Servicios\ServiceOntologia('http://optimusdss.epu.ntua.gr:8890/sparql', 'http://optimus_savona', $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'service_pricepredictor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServicePricePredictor A Optimus\OptimusBundle\Servicios\ServicePricePredictor instance.
     */
    ...
    /**
     * Gets the 'service_weeklyreport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Optimus\OptimusBundle\Servicios\ServiceWeeklyReport A Optimus\OptimusBundle\Servicios\ServiceWeeklyReport instance.
     */
    protected function getServiceWeeklyreportService()
    {
        return $this->services['service_weeklyreport'] = new \Optimus\OptimusBundle\Servicios\ServiceWeeklyReport($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('optimus_instance', 'Savona');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Optimus\\OptimusBundle/Resources/views'), 'OptimusOptimus');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminSensors'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/adminActionPlans'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Optimus\\OptimusBundle\\Entity\\Users', 'lastname', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'OptimusOptimusBundle' => 'Optimus\\OptimusBundle\\OptimusOptimusBundle',
            ...
            'optimus_instance' => 'Savona',
            'optimus_endpoint' => 'http://optimusdss.epu.ntua.gr:8890/sparql',
            'optimus_graph' => 'http://optimus_savona',
            'optimus_sensors' => 14,
            ...
            'action_plan_3' => array(
                ...
                'status' => 0,
                'type' => 3,
                'description' => 'Reduction of the building energy consumption and/or optimizing the thermal comfort by setting the indoor set point temperature according to adaptive comfort concept.',
            ),
            'action_plan_4' => array(
