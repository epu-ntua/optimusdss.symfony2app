...
class Sensor extends \Optimus\OptimusBundle\Entity\Sensor implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Optimus\\OptimusBundle\\Entity\\Sensor' . "\0" . 'id', '' . "\0" . 'Optimus\\OptimusBundle\\Entity\\Sensor' . "\0" . 'name', '' . "\0" . 'Optimus\\OptimusBundle\\Entity\\Sensor' . "\0" . 'url', '' . "\0" . 'Optimus\\OptimusBundle\\Entity\\Sensor' . "\0" . 'color', '' . "\0" . 'Optimus\\OptimusBundle\\Entity\\Sensor' . "\0" . 'display', 'fk_Building');
        }
