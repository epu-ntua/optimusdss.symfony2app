...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gestor_ontologia' => 'getGestorOntologiaService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Blogger\\BlogBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Optimus\\OptimusBundle\\Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Blogger\\BlogBundle\\Entity');
        $c->addDriver($b, 'Optimus\\OptimusBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BloggerBlogBundle' => 'Blogger\\BlogBundle\\Entity', 'OptimusOptimusBundle' => 'Optimus\\OptimusBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_579a724baf54db0e192a5ec61e34d1406b5f55db621090b02a0ec110e7fbe64d');
        return $instance;
    }
    ...
    protected function getGestorOntologiaService()
    {
        return $this->services['gestor_ontologia'] = new \Optimus\OptimusBundle\Servicios\GestorOntologia();
    }
